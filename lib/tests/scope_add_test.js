...
(function() {
  var REDIS_CLIENT, TAGS_COFFEESCRIPT, TAGS_JQUERY, TAGS_NODE, TAGS_NODE2, TAGS_RAILS, Taggable, USER_27, USER_42, bookTagger, should;
  ...
  describe("scope add tests", function() {
    ...
    return describe("taggabler_via_redis", function() {
      it("should set tags on book 1", function(done) {
        bookTagger.set(1, TAGS_NODE, USER_27, function(err) {
          should.not.exist(err);
          done();
        });
      });
      it("should get tags for book 1", function(done) {
        bookTagger.get(1, USER_27, function(err, rsp) {
          should.not.exist(err);
      ...
      it("should set tags on book 2", function(done) {
        bookTagger.set(2, TAGS_JQUERY, USER_27, function(err) {
          should.not.exist(err);
          done();
        });
      });
      it("should get tags for book 2", function(done) {
        bookTagger.get(2, USER_27, function(err, rsp) {
          should.not.exist(err);
      ...
      it("should set tags on book 3", function(done) {
        bookTagger.set(3, TAGS_RAILS, USER_42, function(err) {
          should.not.exist(err);
          done();
        });
      });
      it("should get tags for book 3", function(done) {
        bookTagger.get(3, USER_42, function(err, rsp) {
          should.not.exist(err);
      ...
      it("should set tags on book 4", function(done) {
        bookTagger.set(4, TAGS_COFFEESCRIPT, USER_42, function(err) {
          should.not.exist(err);
          done();
        });
      });
      it("should get tags for book 4", function(done) {
        bookTagger.get(4, USER_42, function(err, rsp) {
          should.not.exist(err);
      ...
      it("should get empty array if book has not been tagged", function(done) {
        bookTagger.get(99, USER_42, function(err, rsp) {
          should.not.exist(err);
          rsp.should.be.empty;
          done();
        });
      ...
      it("should find books from tag", function(done) {
        bookTagger.find("client", USER_42, function(err, rsp) {
          should.not.exist(err);
      ...
      it("should get empty array for non existing tag", function(done) {
        bookTagger.find("maytag", USER_42, function(err, rsp) {
          should.not.exist(err);
          rsp.should.be.empty;
          done();
        });
      ...
      it("should get most popular tags from user 42", function(done) {
        bookTagger.popular(10, USER_42, function(err, rsp) {
          should.not.exist(err);
