...
(function() {
  var DEFAULT, EMPTY_STRING, Taggable, assert, debuglog, redis;
  ...
  Taggable = (function() {
    ...
    */
    ...
    Taggable.prototype.get = function(scope, id, callback) {
      if (callback) {
        this.redisClient.smembers("" + this.prefix + ":" + scope + ":" + this.taggable + ":" + id + ":tags", callback);
      } else {
        this.redisClient.smembers("" + this.prefix + ":" + this.taggable + ":" + scope + ":tags", id);
      }
    };
